...
def create_restaurant(name,email,address,password,image,description,deliveryradius,openinghrs):
    restaurant = Restaurant(Name=name,Email=email,Address=address,image=image,Description=description,Delivery_radius=deliveryradius,Opening_hours=openinghrs)
