...
class Items(db.Model):
    ...
    R_id = db.Column(db.Integer,db.ForeignKey("R_id"),nullable=False)
...
class Order(db.Model):
    ...
    customer_id = db.Column(db.Integer,db.ForeginKey("C_id"),nullable=False)
    items = db.relationship("Items",secondary=orders,backref="Order")
    restaurant_id = db.Column(db.Integer,db.ForeignKey("R_id"),nullable=False)    